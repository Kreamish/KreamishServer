...
(
    ...
    CONSTRAINT FAVORITE_MEMBER_FK FOREIGN KEY (MEMBER_ID) REFERENCES MEMBER (MEMBER_ID),
    CONSTRAINT FAVORITE_ITEM_SIZES_FK FOREIGN KEY (ITEM_SIZES_ID) REFERENCES ITEM_SIZES (ITEM_SIZES_ID)
);
